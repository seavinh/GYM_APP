...
class PaymentProvider extends ChangeNotifier {
  ...
  Future<void> loadPayments(AuthProvider auth, {int? memberId, bool refresh = false}) async {
    if (refresh) {
      _currentPage = 1;
      _payments = [];
    }
  ...
  Future<Payment?> createPayment(AuthProvider auth, Map<String, dynamic> data) async {
    try {
  ...
  Future<bool> updatePayment(AuthProvider auth, int id, Map<String, dynamic> data) async {
    try {
  ...
  Future<bool> deletePayment(AuthProvider auth, int id) async {
    try {
  ...
  Future<Map<String, dynamic>?> getReceipt(AuthProvider auth, int paymentId) async {
    try {
